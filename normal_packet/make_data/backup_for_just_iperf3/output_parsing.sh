...
# sed -n '/receiver/p' /home/controller/IoT/normal_packet/output/output_servers_192.0.0.21_192.0.0.11_60003_60002.txt
#	cat /home/controller/IoT/normal_packet/output/$c/output_servers_${a}_${b}_${e}_${f}.txt|awk -F 'Bytes  ' {'print $2'} > /home/controller/IoT/normal_packet/output/$c/data_output_servers_${a}_${b}_${e}_${f}.txt
	...
	sed -n '/receiver/p' /home/controller/IoT/normal_packet/output/$c/output_servers_${a}_${b}_${e}_${f}.txt > /home/controller/IoT/normal_packet/output/$c/data_output_servers_${a}_${b}_${e}_${f}.txt
