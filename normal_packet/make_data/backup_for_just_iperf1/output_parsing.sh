...
eval d='$'{input_length_path[$e]}
	...
	cat /home/controller/IoT/normal_packet/output/$c/output_servers_${a}_${b}_${e}_${f}.txt|awk -F '  receiver' {'print $2'} > /home/controller/IoT/normal_packet/output/$c/data_output_servers_${a}_${b}_${e}_${f}.txt
