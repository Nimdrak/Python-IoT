...
def Routing_rule_post_only_src(Device_id, Priority, Type, Out_port, Src_IP, ARP_IP, ARP_IP_Type):
...
def Routing_rule_post_only_dst(Device_id, Priority, Type, Out_port, Dst_IP, ARP_IP, ARP_IP_Type):
...
#Routing_rule_post("of:00009cebe83128b4","65051","OUTPUT",'2',"192.0.0.3/32","192.0.0.1/32","0x0800","ETH_TYPE")
