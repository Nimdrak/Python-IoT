...
/home/byounguklee/mininet/custom/con_python/normal_packet/make_data/delete_ex_data.sh


#################################################

IFS=',' read -r -a input_length_path <<< $(cat /home/byounguklee/mininet/custom/con_python/output_txt/output_link_length.txt)
...
done < /home/byounguklee/mininet/custom/con_python/output_txt/output_ip_mean.txt
...
done < /home/byounguklee/mininet/custom/con_python/output_txt/output_ip_mean_193.txt
...
done < /home/byounguklee/mininet/custom/con_python/output_txt/output_port.txt
...
done < /home/byounguklee/mininet/custom/con_python/output_txt/output_ip_link.txt
...
#ssh pi@$a iperf -s -u -U -f m -p $e -w 320k -e>> /home/byounguklee/mininet/custom/con_python/normal_packet/output/output_servers_${a}_${b}_${e}_${f}.txt 2>> /home/byounguklee/mininet/custom/con_python/normal_packet/output/output_servers_${a}_${b}_${e}_${f}.txt &
...
rm /home/byounguklee/mininet/custom/con_python/normal_packet/output/*.txt
...
ssh server@$h ./normal_at_client.sh $a $e $h $c $d 10 10 $b $f & # a and e! neither b nor f
#sleep 5
